  ...
  return (
    <div className="px-4 md:px-[10%] gap-10 font-rubik flex flex-col justify-center items-center h-auto py-6 md:py-[3%]">
      <div className="w-full text-center text-[#FDFDFD]">
        <h1 className="text-2xl md:text-3xl"><b>REACH ME OUT</b></h1>
      </div>
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-10">
        <div className="flex flex-col justify-start gap-5">
          <h2 className="text-[#F5B301] text-xl md:text-2xl"><b>SEND ME A MESSAGE</b></h2>
          ...
          <textarea placeholder="Message" className="p-4 border-b-4 h-60 md:h-40 border-[#F5B301]"></textarea>
